---
name: content-audit
description: Audits website content for language errors, tone consistency, SEO issues, and accessibility problems. Use when reviewing existing web content - written by humans or AI - to find and fix issues.
argument-hint: "[file-path-or-url]"
---

# Content Audit for Web
...
- **If a URL is provided:** Use Playwright to navigate to the URL, take a snapshot, and extract the visible content. Also take a screenshot to evaluate content in its visual context
- **If a directory is provided:** Glob for HTML/JSX/TSX/MDX files and audit each one
